...
@Disabled
@Autonomous(name = "Red CLOSE Dunk/MGlyph")
public class AutonomousCloseDunkRedFastTurn extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.driveTrain.moveToInches(-10, .2);
        robot.intakeMecanism.outtakeSlowly();
        robot.intakeMecanism.intake();
        robot.driveTrain.moveToInches(4, .2);
        robot.driveTrain.moveToInches(-14, .2);
        sleep(500);
        robot.driveTrain.gyroTurn(.25, targetAngle - 15);
        robot.driveTrain.gyroTurn(.05, targetAngle - 15);
