...
@Disabled
@Autonomous(name = "Blue FAR MG")
public class AutonomousFarDunkBlueMG extends LinearOpMode {

    @Override
    public void runOpMode() throws InterruptedException {
        AutonomousUtil.AllianceColor startingColor = AutonomousUtil.AllianceColor.Blue;
        ...
        robot.driveTrain.gyroTurn(turnSpeed, 0);
        ...
        switch (vuMark) {
            case CENTER:
                robot.driveTrain.strafeToRightPosition(strafePower, targetAngle, DistanceUnit.INCH, closestPosition + 7.5);
                break;
            case RIGHT:
            ...
            default:
            case LEFT:
                robot.driveTrain.strafeToRightPosition(strafePower, targetAngle, DistanceUnit.INCH, closestPosition);
                break;
        }
